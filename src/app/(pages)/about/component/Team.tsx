    ...
    <section className="bg-[#FFFBF6] py-16">
      <div className="container mx-auto px-6 text-center">
        ...
        <p className="text-gray-600 mt-4 max-w-2xl mx-auto">
          Team always taking actions that have a significant, lasting, and
          positive impact, whether on individuals, communities, or larger
          systems.
        </p>
...
const TeamCard = ({
  ...
  member: { name: string; role: string; image: string; grayscale: boolean };
}) => (
